...
export const MorphTargetLabelMapping = {
  ...
  ForeheadDepth: "前后",
  ForeheadHeight: "上下",
  ZygomaticArchWidth: "宽度",
  ZygomaticArchDepth: "前后",
  ZygomaticArchHeight: "上下",
  AppleCheekWidth: "宽度",
  AppleCheekDepth: "前后",
  AppleCheekHeight: "上下",
  Cheek0Width: "宽度",
  ...
  Cheek1Depth: "前后",
  Cheek1Height: "上下",
  PhiltrumSidesWidth: "宽度",
  PhiltrumSidesDepth: "前后",
  PhiltrumSidesHeight: "上下",
  JawWidth: "宽度",
  JawDepth: "前后",
  JawHeight: "上下",
  JawSidesWidth: "宽度",
  ...
  MandibleDepth: "前后",
  MandibleHeight: "上下",
  MandibleCornersWidth: "宽度",
  MandibleCornersDepth: "前后",
  MandibleCornersHeight: "上下",
  EyeBrowHeight: "高度",
  MouseCornersWidth: "宽度",
