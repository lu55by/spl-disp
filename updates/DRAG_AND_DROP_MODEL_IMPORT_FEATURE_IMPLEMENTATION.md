...
- **Integration**: Added `DragAndDropOverlay` to `src/components/SplicingModelsMainContainer.vue` so it sits on top of the generic UI and 3D scene.
...
- `src/components/SplicingModelsMainContainer.vue` (Modified)
